                            ...
                            <div class="main-menu-area">
                                <div class="main-menu">
                                    ...
                                    <nav class="desktop-menu">
                                        <ul>
                                            <li class="active"><a href="/Bookstore">Home</i></a>   
                                            </li>
                                            
                                            <li><a href="/Bookstore/shop">shop</i></a>
                                                
                                            </li>
                                            
                                            <li><a href="/Bookstore/shop">Contact us</a></li>
                                        </ul>
                                    </nav>
                                    ...
                                    <ul class="nav justify-content-end">
                                        ...
                                        <li class="user-hover">
                                            ...
                                            <ul class="dropdown-list">
                                                <li><a href="/Bookstore/login">login</a></li>
                                                <li><a href="/Bookstore/register">register</a></li>
                                                <li><a href="/Bookstore/myaccount">my account</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="/Bookstore/wishlist">
